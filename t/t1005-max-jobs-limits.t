...
test_expect_success 'create fake_user.json' '
	cat <<-EOF >fake_user.json
	{
		"data" : [
			...
			{"userid": 5011, "bank": "account2", "def_bank": "account3", "fairshare": 0.11345, "max_jobs": 1, "max_active_jobs": 2}
		]
	}
	EOF
'
...
test_expect_success 'increase the max jobs count of the user' '
	...
	{
		"data" : [
			{"userid": 5011, "bank": "account3", "def_bank": "account3", "fairshare": 0.45321, "max_jobs": 3, "max_active_jobs": 4}
		]
	}
	EOF
'
