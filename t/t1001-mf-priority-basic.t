...
test_expect_success 'create fake_payload.py' '
	...
	bulk_update_data = {
		"data" : [
			{"userid": userid, "bank": "account3", "def_bank": "account3", "fairshare": 0.45321, "max_jobs": 10, "max_active_jobs": 12},
			{"userid": userid, "bank": "account2", "def_bank": "account3", "fairshare": 0.11345, "max_jobs": 10, "max_active_jobs": 12}
		]
	}
...
test_expect_success 'create a fake payload with a 0 fairshare key-value pair' '
	...
	bulk_update_data = {
		"data" : [
			{"userid": userid, "bank": "account4", "def_bank": "account3", "fairshare": 0.0, "max_jobs": 10, "max_active_jobs": 12}
		]
	}
	flux.Flux().rpc("job-manager.mf_priority.rec_update", json.dumps(bulk_update_data)).get()
	EOF
...
test_expect_success 'pass special key to user/bank struct to nullify information' '
	...
	{
		"data" : [
			{"userid": 5011, "bank": "account3", "def_bank": "account3", "fairshare": 0.45321, "max_jobs": -1, "max_active_jobs": 12}
		]
	}
	EOF
...
test_expect_success 'resend user/bank information with valid data and successfully submit a job' '
	...
	{
		"data" : [
			{"userid": 5011, "bank": "account3", "def_bank": "account3", "fairshare": 0.45321, "max_jobs": 2, "max_active_jobs": 4}
		]
	}
	EOF
