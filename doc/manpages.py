...
man_pages = [
    ...
    (
        "man1/flux-account-add-config",
        "flux-account-add-config",
    ...
    (
        ...
        "flux-account-delete-config",
        "delete a key-value pair from config_table",
        [author],
        1,
    ),
    (
        "man1/flux-account-list-configs",
        "flux-account-list-configs",
        "list all configuration parameters in config_table",
        [author],
        1,
    ),
    (
        "man1/flux-account-view-config",
        "flux-account-view-config",
        "view a specific key-value pair from config_table",
        [author],
        1,
    ),
]
